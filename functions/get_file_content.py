...
schema_get_file_content = {
    ...
    "function": {
        ...
        "description": "returns the files content as a string. The amount of charachters to be read are capped at the global variable 'MAX_CHARS', if it file exeeds the character limits the string will contain a warning stating it was truncuated",
        "parameters": {
            "type": "object",
            "properties": {
                "file_path": {
                    "type": "string",
                    "description": "The name of the file to be read, relative to the working directory (default is the working directory itself)",
                },
            },
        },
    },
